...
// Advanced the clock by one hour with a value parameter
...
int main()
{
    ...
    cout << "Advanced the clock one hour with a value parameter" << endl;
    advanceOneHourVal(c1);
    c1.printTime();

    cout << "Advanced the clock one hour with a pointer parameter" << endl;
    advanceOneHourPtr(&c1);
    c1.printTime();

    cout << "Advanced the clock one hour with a reference parameter" << endl;
    advanceOneHourRef(c1);
    c1.printTime();

    cout << "Setting the clock to 8:09:10 with cascading setters "
    << "returning an instance" << endl;
